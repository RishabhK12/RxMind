  ...
  group('WCAG 2.2 AA body text contrast', () {
    final pairs = <String, (Color fg, Color bg)>{
      'light onSurface/surface':
          (ThemeTokens.lightOnSurface, ThemeTokens.lightSurface),
      'light onSurface/scaffold':
          (ThemeTokens.lightOnSurface, ThemeTokens.lightScaffold),
      'light onPrimary/primary':
          (ThemeTokens.lightOnPrimary, ThemeTokens.lightPrimary),
      ...
      'dark onSurface/surface':
          (ThemeTokens.darkOnSurface, ThemeTokens.darkSurface),
      'dark onSurface/scaffold':
          (ThemeTokens.darkOnSurface, ThemeTokens.darkScaffold),
      'dark onPrimary/primary':
          (ThemeTokens.darkOnPrimary, ThemeTokens.darkPrimary),
      'dark onError/error': (ThemeTokens.darkOnError, ThemeTokens.darkError),
      'hcLight onSurface/surface':
          (ThemeTokens.hcLightOnSurface, ThemeTokens.hcLightSurface),
      'hcLight onPrimary/primary':
          (ThemeTokens.hcLightOnPrimary, ThemeTokens.hcLightPrimary),
      'hcDark onSurface/surface':
          (ThemeTokens.hcDarkOnSurface, ThemeTokens.hcDarkSurface),
      'hcDark onPrimary/primary':
          (ThemeTokens.hcDarkOnPrimary, ThemeTokens.hcDarkPrimary),
    };
